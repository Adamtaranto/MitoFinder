...
def main():
    ...
    record = SeqIO.read(open(sys.argv[1].split("_raw.gff")[0] + ".gb"), "genbank")
                ...
                if "translation" in feature.qualifiers:
                    if feature.location.strand == -1:
                        start = Seq(
                            str(
                                record.seq[
                                    feature.location.end - 3 : feature.location.end
                                ]
                            )
                        )
                        ...
                        stop = Seq(
                            str(
                                record.seq[
                                    feature.location.start : feature.location.start + 3
                                ]
                            )
                        )
                        if not feature.qualifiers["gene"][0].split("_")[0] in dico_lend:
                            ...
                            dico_end[feature.qualifiers["gene"][0].split("_")[0]] = str(
                        ...
                        if (
                            ...
                            dico_start[
                                ...
                                Seq(
                                    str(
                                        record.seq[
                                            feature.location.start : feature.location.start
                                            + 3
                                        ]
                                    )
                                )
            ...
            if "product" in feature.qualifiers:
                if feature.location.strand == -1:
                    ...
                    if not feature.qualifiers["gene"][0].split("_")[0] in dico_lstart:
                        ...
                        dico_start[feature.qualifiers["gene"][0].split("_")[0]] = str(
                            start.reverse_complement()
                        )
                    else:
                        if (
                            dico_lstart.get(feature.qualifiers["gene"][0].split("_")[0])
                            < feature.location.end
                        ):
                            dico_lstart[
                                feature.qualifiers["gene"][0].split("_")[0]
                    ...
                    if not feature.qualifiers["gene"][0].split("_")[0] in dico_lend:
                        ...
                        if (
                            dico_lend.get(feature.qualifiers["gene"][0].split("_")[0])
                            > feature.location.start
                        ):
                            dico_lend[
                                feature.qualifiers["gene"][0].split("_")[0]
    ...
    for line in open(sys.argv[1]):
        ...
        if "_" in gene:
            if line.split("\t")[6] == "-":
                if int(line.split("\t")[3]) > int(
                    dicogl.get(gene.split("_")[0]).split(";")[0].split("\t")[3]
                ):
                    dicog[gene.split("_")[0]] += 1
                    dicogl[gene.split("_")[0]] = (
                        line + ";" + dicogl.get(gene.split("_")[0])
                    )
                else:
                    dicog[gene.split("_")[0]] += 1
                    dicogl[gene.split("_")[0]] = (
                        dicogl.get(gene.split("_")[0]) + ";" + line
                    )
            elif line.split("\t")[6] == "+":
                if int(line.split("\t")[3]) < int(
                    dicogl.get(gene.split("_")[0]).split(";")[0].split("\t")[3]
